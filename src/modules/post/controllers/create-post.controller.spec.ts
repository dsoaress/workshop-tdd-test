...
describe("CreatePostController", () => {
  ...
  beforeEach(() => {
    createPostUseCase = { execute: jest.fn() } as any as CreatePostUseCase;
  ...
  it("should create a post", async () => {
    ...
    const request = { body: { title, excerpt, content } } as Request;
  ...
  it("should return 400 if body data is invalid", async () => {
    ...
    const request = { body: { excerpt, content } } as Request;
    await createPostController.execute(request, response);
